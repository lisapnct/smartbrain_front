...
class SignIn extends React.Component {
    ...
    onSubmitSignIn = () => {
        fetch('https://infinite-anchorage-19440.herokuapp.com/signin', {
            method: 'post',
    ...
    render() {
        ...
        return (
            <div className="flex items-center pt6">
                    ...
                    <main className="pa4 white">
                        <div className="measure">
                            ...
                            <div className="lh-copy mt3">
                                <p onClick={() => onRouteChange('register')} href="#0" className="f6 pointer white link dim black db">Register</p>
                            </div>
                        </div>
                    </main>
                </article>
